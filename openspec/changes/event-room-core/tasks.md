...
- [x] 9.1 Full workspace check green: `pnpm -w typecheck`, `pnpm -w lint`, `pnpm -w build`, `pnpm -w test` — verify all pass, including `apps/party`'s `@cloudflare/vitest-pool-workers` suite.
